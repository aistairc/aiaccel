...
from aiaccel.config import BaseConfig, Config, ConfileWrapper, JsonOrYamlObjectConfig, load_config
...
class TestJsonOrYamlObjectConfig(BaseTest):
    ...
    def test_get_property(self):
        ...
        none_config = JsonOrYamlObjectConfig({}, "json_object")
        assert none_config.get_property("key") is None
        assert self.config.get_property("sleep_time") == {"master": 1, "optimizer": 1, "scheduler": 1}
