...
class TestAbstractOptimizer(BaseTest):
    ...
    def setup_optimizer(self, clean_work_dir):
        options = {"config": self.config_json, "resume": 0, "clean": False, "fs": False, "process_name": "optimizer"}
    ...
    def test_inner_loop_main_process(self):
        ...
        param = [
            {"parameter_name": "x1", "type": "FLOAT", "value": 0.2},
    ...
    def test_cast(self):
        org_params = [
            {"parameter_name": "x1", "type": "INT", "value": 0.1},
        ...
        org_params = [
            {"parameter_name": "x1", "type": "CATEGORICAL", "value": "a"},
        ...
        org_params = [
            {"parameter_name": "x1", "type": "ORDINAL", "value": [1, 2, 3]},
