...
class TestAbstractModule(BaseTest):
    ...
    def setup_module(self):
        options = {"config": str(self.config_json), "resume": None, "clean": False, "fs": False, "process_name": "test"}
    ...
    def test_get_module_type(self):
        ...
        commandline_args = ["start.py", "--config", str(self.config_json)]
    ...
    def test_resume(self):
        options = {"config": str(self.config_json), "resume": None, "clean": False, "process_name": "test"}
