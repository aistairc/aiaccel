...
class TestCreateAbciBatchFile(BaseTest):
    def test_create_abci_batch_file(self, clean_work_dir, get_one_parameter, load_test_config, data_dir, work_dir):
    ...
    def parameters(self):
        return {
            "trial_id": 99,
            "parameters": [
                {"parameter_name": "x1", "type": "FLOAT", "value": -4.716525234779937},
                {"parameter_name": "x2", "type": "FLOAT", "value": 123456},
            ],
