...
common_pre_dependencies ?= status

$(eval stage$(min_stage): $(common_pre_dependencies) .WAIT $(stage$(min_stage)_dependencies))

$(foreach n,$(shell seq $$(($(min_stage)+1)) $(max_stage)), \
  $(eval stage$(n): $(common_pre_dependencies) .WAIT $(stage$(n)_dependencies) stage$(shell echo $$(($(n)-1)))) \
)
