...
def main() -> None:
    """Main entry point for aiaccel-torch."""
    parser = argparse.ArgumentParser(
        prog="aiaccel-torch",
        description="PyTorch apps for aiaccel",
    )
    ...
    command_map = {
        "train": "aiaccel.torch.apps.train",
    }
    ...
    try:
        ...
        sys.argv = [f"aiaccel-torch {args.command}"] + args.args
