...
def main() -> None:
    """Main entry point for aiaccel-jobs."""
    parser = argparse.ArgumentParser(
        prog="aiaccel-jobs",
        description="Job management utilities for aiaccel",
    )
    parser.add_argument("command", help="Command to run (e.g., local, abci3)")
    ...
    command_map = {
        "local": "aiaccel.jobs.cli.local",
        "abci3": "aiaccel.jobs.cli.abci3",
    }
    ...
    try:
        ...
        sys.argv = [f"aiaccel-jobs {args.command}"] + args.args
