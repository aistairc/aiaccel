...
どの `x1` と `x2` の組み合わせが探索されたかを表にまとめると以下のようになります．
記号の意味はプロットと同じです．
...
従って DUPRECATABLE_RANDOM は，例えば 10 個のパラメータがそれぞれ 10 個の選択肢を持つような場合に，メモリの大きさの観点から RANDOM よりも優れていると言えます．
