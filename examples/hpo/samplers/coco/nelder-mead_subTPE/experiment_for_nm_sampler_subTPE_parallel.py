...
def experiment_bbob() -> None:
    ...
    ### input
    suite_name = "bbob"
    output_folder = f"optuna-neldermead-subTPE-mcTmvF-func_id{func_id}-dim{dim}-instance{instance}"
    ...
    for problem in suite:  # this loop will take several minutes or longer
        ...
        study = optuna.create_study(
            sampler=NelderMeadSampler(search_space=search_space, seed=optuna_seed, block=False, sub_sampler=sub_sampler)
        )
